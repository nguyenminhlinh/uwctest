  ...
  function changeRoute8F() {
    ...
    return (
        <Container className="mt-1" fluid>
            <Row>
                <div className="mt-2"><b>MCPs cần dọn (&gt; 95%)</b> : 1</div>
                <div className="mt-2"><b>Số janitors đang trong ca làm việc</b> : 20</div>
                <div className="mt-2"><b>Số collectors đang chờ được phân công</b> : 5</div>
                <div className="mt-2"><b>Số xe chưa được sử dụng</b> : 5 (3 troller và 2 trunk)</div>
            </Row>
            <Row>
                <div className="map">
